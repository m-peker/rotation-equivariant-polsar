"""Exp. 32 - the patch-size sweep at ten seeds.

The disjoint protocol has a seed spread of roughly 9 pp, so at three seeds the
sweep cannot support any ordering. Ten seeds is the minimum that makes the
table interpretable; the conclusion it is used for -- that the ranking does not
survive the removal of patch overlap -- has to rest on intervals, not means.
